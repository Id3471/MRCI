      ...
      <div class="w-full max-w-2xl">
        <div class="relative rounded-2xl bg-white shadow-xl">
          <div class="flex items-center justify-center relative px-6 py-4 border-b border-gray-100">
            <h3 class="text-lg font-semibold text-gray-900">Ajouter une résidence</h3>
          ...
          <form
            (ngSubmit)="submit.emit(formValue)"
            ...
            <div class="grid grid-cols-1 gap-4">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  />
                  <p class="mt-1 text-xs text-gray-500">PNG, JPG (MAX. 2MB env.)</p>
                </div>
              </div>
            </div>
...
export class ResidenceCreateModalComponent {
  ...
  @Output() submit = new EventEmitter<CreateResidenceDto>();
